		...
		<!-- Cuerpo de catalogo -->
		<div id="ctlgModulo" class="panel-body" style="height: 74%;"> 
		    <div class="row">
		      <div class="col-md-5"  >
				<div class="input-group">
				  <!--<span class="input-group-addon glyphicon glyphicon-search" id="sizing-addon2"></span>-->
				  	...
				  	<input type="text" class="dato_1 form-control" 
				  		id="buscardorTxt" placeholder="Ingresar nombre "
				  		aria-describedby="sizing-addon2"
			  			onkeypress="nucleo.verificarDatosInputPublic(event,this,'buscardorTxt')"
				  		onkeyup="mtdModulo.cargarCatalogoPublic(1)" 
				...
				<div class="col-md-4 col-md-offset-1" >
				    <button type="button" class="btn btn-default" id="btnGenerarReporte" onclick="reportes.generar2Public(['mtn_modulo'],['nombre'],'CFG-2COLL','MODULOS DEL SISTEMA')" >
				  		Generar Reporte
				  	</button>
				</div>	
		    </div>
		...
		<div id="pgnModulo" style="position: relative;bottom: 0;width: 100%;height: 14%;">
			<hr>

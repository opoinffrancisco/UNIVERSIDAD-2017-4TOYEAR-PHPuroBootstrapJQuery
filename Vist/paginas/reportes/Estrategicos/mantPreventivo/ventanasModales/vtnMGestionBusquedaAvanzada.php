				...
				<form id="form" method="POST" >
						...
						<div id="listas">													
							<div class="row">
								<div class="col-md-12">
									<h3 class="panel-title">
										<b>Aviso:</b>  La búsqueda avanzada no interviene en los resultados del reporte, solo en conseguir el equipo.
									</h3> 
								</div>
							</div>
							<hr>
...
<!--/////////////////////////////////////////////////////-->
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
									    ...
									    <input type="number" class="form-control input-sm" id="cedulaTxt" placeholder="25177460">
									</div>																					
								</div>																												
							</div>
							...
							<div class="row">
								<div class="col-md-2 col-md-offset-10"  >
									...
									<a href="javascript:;" onclick="mtdMantenimientoPreventivo.opcionesBusquedaAvanvadaPublic()">

		...
		<!-- Cuerpo de catalogo -->
		<div id="ctlgCLogcDistribucion" class="panel-body" style="height: 74%;"> 
		    <div class="row">
		      <div class="col-md-5"  >
				<div class="input-group">
				  ...
				  <input type="text" class="dato_1 form-control" id="buscardorTxt" 
			  		...
			  		onkeyup="mtdCLogcDistribucion.cargarCatalogoPublic(1)" 
				...
				<div class="col-md-4 col-md-offset-1 generarRptBtnDiv" >
				    <button type="button" class="btn btn-default" id="btnGenerarReporte" onclick="reportes.generar2Public(['cfg_c_logc_Distribucion'],['nombre'],'CFG-2COLL','DISTRIBUCIONES EN LAS CARACTERISTICAS LOGICAS')" >
				  		Generar Reporte
				  	</button>
				</div>	
		    </div>
		...
		<div id="pgnCLogcDistribucion" style="position: relative;bottom: 0;width: 100%;height: 14%;">
			<hr>

		...
		<!-- Cuerpo de catalogo -->
		<div id="ctlgCaracteristicasPerifericos" class="panel-body" style="height: 74%;"> 
		    <div class="row">
				<div class="col-md-4"  >
				    ...
				    <label for="Tipo" style="color:#000;" >Filtrar por modelo:</label>					
				  	<div id="divBuscadorTxt" class="form-group">
						<div class="input-group">
						  ...
						  <input type="text" maxlength="30" min="1" class="filtro_1 form-control" id="buscardorTxt" placeholder="Ingresar modelo" aria-describedby="sizing-addon2"
				...
				<div class="col-md-2 col-md-offset-0" >
				    ...
				    <button type="button" class="btn btn-default" id="btnGenerarReporte" onclick="reportes.generarFiltrarPublic('CFG-3COLL-C-PERIFERICOS','CARACTERÍSTICAS PRINCIPALES PARA PERIFERICOS EN EL SISTEMA')" >
				  		Generar reporte
				  	</button>
				</div>	   
		    </div>
		...
		<div id="pgnCaracteristicasPerifericos" style="position: relative;bottom: 0;width: 100%;height: 14%;">
			<hr>
...
<script type="text/javascript">
				...
				$(document).ready(function() {
					...
					$('#btipoListD').on('change',function () {
						...
						mtdCaracteristicasPerifericos.cargarCatalogoPublic(1,filtro2_);	

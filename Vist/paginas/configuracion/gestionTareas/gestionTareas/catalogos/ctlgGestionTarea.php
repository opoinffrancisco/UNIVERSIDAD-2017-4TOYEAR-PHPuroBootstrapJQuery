		...
		<!-- Cuerpo de catalogo -->
		<div id="ctlgTarea" class="panel-body" style="height: 74%;"> 
		    <div class="row">
		      <div class="col-md-5"  >
				<div class="input-group">
				  ...
				  <span class="input-group-addon" id="sizing-addon2" >Buscar</span>
					<input type="text" class="dato_1 form-control" id="buscardorTxt"        
							...
							onkeypress="nucleo.verificarDatosInputPublic(event,'cfg_tarea','nombre',this,'divNombreTxt')"
				    		data-cantmax="100" maxlength="100" data-cantmin="10"  data-vexistencia="1" 
		      ...
		      <div class="col-md-1 nuevoBtnDiv" >
			    <a href="javascript:;" onclick="ventanaModal.cambiaMuestraVentanaModalPublic(configuracion.urlsPublic().modTareas.tabs.tarea.ventanaModal,1,1)">
				...
				<div class="col-md-4 col-md-offset-1 generarRptBtnDiv" >
				    <button type="button" class="btn btn-default" id="btnGenerarReporte" onclick="reportes.generar2Public(['cfg_tarea'],['nombre'],'CFG-2COLL','TAREAS PARA MANTENIMINETO EN EL SISTEMA')" >
				  		Generar Reporte
				  	</button>
				</div>				      
		    </div>
		...
		<div id="pgnTarea" style="position: relative;bottom: 0;width: 100%;height: 14%;">
			<hr>

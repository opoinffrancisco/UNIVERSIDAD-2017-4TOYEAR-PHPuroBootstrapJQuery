		...
		<div id="vtnCCompInterfaz" class="panel panel-primary ventana-modal-panel-expandido ">
			<!-- Cabecera -->
			<div class="panel-heading">
				<h3 class="panel-title">
					Gestionar la interfaz de conexión
					<a href="javascript:;" id="ventana-modal-panel-cerrar" class="ventana-modal-panel-cerrar" style="" 
					onclick="ventanaModal.ocultarPulico('ventana-modal'),mtdCFiscInterfaz.restablecerFormPublic()">x</a>
				</h3> 
			</div> 
							  ...
							  <div class="col-md-6 col-md-offset-3">
   							      <label for="recurso">Nombre:</label>							  
								    	...
								    	<input type="text" name="nombre" class="campo-clave campo-control form-control input-sm" id="nombreTxt" placeholder="Ingresar nombre" 
											...
											onkeyup="nucleo.verificarDatosPublic('cfg_c_fisc_interfaz_conexion','nombre','nombreTxt','divNombreTxt')" 
								    		data-cantmax="10" maxlength="10" data-cantmin="2" data-vexistencia="1" 
...
<script type="text/javascript">
		mtdCFiscInterfaz.Iniciar();
		mtdCFiscInterfaz.cargarCatalogoPublic(1);	
		nucleo.asignarPermisosBotonesPublic(22);
		nucleo.guardarBitacoraPublic("INGRESO EN EL MODULO DE CONFIGURACIÓN - CARACTERISTICAS FISICAS - SECCIÓN : INTERFAZ DE CONEXIÓN "); 

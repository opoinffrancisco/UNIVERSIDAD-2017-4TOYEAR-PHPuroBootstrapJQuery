		...
		<!-- Cuerpo de catalogo -->
		<div id="ctlgCCompInterfaz" class="panel-body" style="height: 74%;"> 
		    <div class="row">
		      <div class="col-md-5"  >
				  ...
				  <span class="input-group-addon" id="sizing-addon2" >Buscar</span>
				 	<input type="text" class="dato_1 form-control" id="buscardorTxt" 	
				 		placeholder="Ingresar nombre " aria-describedby="sizing-addon2"
				  		...
				  		onkeyup="mtdCFiscInterfaz.cargarCatalogoPublic(1)" 
				...
				<div class="col-md-4 col-md-offset-1 generarRptBtnDiv" >
				    <button type="button" class="btn btn-default" id="btnGenerarReporte" onclick="reportes.generar2Public(['cfg_c_fisc_interfaz_conexion'],['nombre'],'CFG-2COLL','INTERFACES DE CONEXIÓN EN LAS CARACTERISTICAS FISICAS')" >
				  		Generar Reporte
				  	</button>
				</div>	
		    </div>
		...
		<div id="pgnCCompInterfaz" style="position: relative;bottom: 0;width: 100%;height: 14%;">
			<hr>
...
<script type="text/javascript">
		...
		nucleo.guardarBitacoraPublic("INGRESO EN EL MODULO DE CONFIGURACIÓN - CARACTERISTICAS FISÍCAS : SECCIÓN - INTERFAZ DE CONEXIÓN"); 	
</script>
		...
		<!-- Cuerpo de catalogo -->
		<div id="ctlgCCompTipo" class="panel-body" style="height: 74%;"> 
		    <div class="row">
		      <div class="col-md-5"  >
				  	...
				  	<input type="text" class="dato_1 form-control" id="buscardorTxt"   
				  		...
				  		onkeyup="
				  				mtdCFiscTipo.cargarCatalogoPublic(1)
					  				" 
			    		data-cantmax="30" maxlength="30" data-cantmin="3" min="3" 
				...
				<div class="col-md-4 col-md-offset-1 generarRptBtnDiv" >
				    <button type="button" class="btn btn-default" id="btnGenerarReporte" onclick="reportes.generar2Public(['cfg_c_fisc_tipo'],['nombre'],'CFG-2COLL','TIPOS EN LAS CARACTERISTICAS FISICAS')" >
				  		Generar Reporte
				  	</button>
				</div>		
		    </div>
		...
		<div id="pgnCCompTipo" style="position: relative;bottom: 0;width: 100%;height: 14%;">
			<hr>

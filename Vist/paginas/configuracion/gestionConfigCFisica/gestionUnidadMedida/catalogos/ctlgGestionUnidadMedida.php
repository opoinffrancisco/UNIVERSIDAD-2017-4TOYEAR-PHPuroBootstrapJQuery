		...
		<!-- Cuerpo de catalogo -->
		<div id="ctlgCCompUMCapacidad" class="panel-body" style="height: 74%;"> 
		    <div class="row">
		      <div class="col-md-5"  >
				<div class="input-group">
				  <!--<span class="input-group-addon glyphicon glyphicon-search" id="sizing-addon2"></span>-->
				  	...
				  	<input type="text" class="dato_1 form-control" id="buscardorTxt" 
				  		...
				  		onkeyup="mtdCFiscUMCapacidad.cargarCatalogoPublic(1)" 
				...
				<div class="col-md-4 col-md-offset-1 generarRptBtnDiv" >
				    <button type="button" class="btn btn-default" id="btnGenerarReporte" onclick="reportes.generar2Public(['cfg_c_fisc_unidad_medida'],['nombre','abreviatura'],'CFG-3COLL','UNIDADES DE MEDIDAS EN LAS CARACTERISTICAS FISICAS')" >
				  		Generar Reporte
				  	</button>
				</div>
		    </div>
						...
						<table id="catalogo" class="table table-bordered table-hover table-striped">
						 <thead>
						  <tr  class="row">
						   ...
						   <th  class="col-md-2">Abreviatura</th> 
		...
		<div id="pgnCCompUMCapacidad" style="position: relative;bottom: 0;width: 100%;height: 14%;">
			<hr>

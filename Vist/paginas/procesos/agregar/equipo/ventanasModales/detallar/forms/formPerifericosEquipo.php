						...
						<div class="col-md-9">
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="row">			
										<div class="col-md-6">
											<div class="form-group">
												<label for="1">Interfaz</label>
											    <input type="text" class="form-control" id="interfaztxt" disabled="TRUE">
											</div>												
										</div>																					
									</div>
							...
							<div class="row">
							    ...
							    <div class="col-md-12"  style="background-color:#fff">
									<div class="catalogo">
										<table id="listVtnSeriesPerifericos" class="table table-bordered table-hover ">
										 <thead>
										  <tr  class="row">
											  	...
											  	<td style=" padding: 0px; text-align: center;vertical-align:middle; border: 1px solid white;" class="col-md-6">
											  		<div class="form-group">
											  			<input type="text" class="form-control" id="input1" placeholder="Introducir serial" style="margin-bottom: 0px; box-shadow: unset;"
											  				onkeyup="nucleo.verificarExistenciaPublic('eq_periferico','serial','fila1 #input1','fila1 #input1')" 
											  			>
											  		</div>
											  	</td>
											  	<td style=" padding: 0px; text-align: center;vertical-align:middle; border: 1px solid white;" class="col-md-6">
											  		<div class="form-group">
											  			<input type="text" class="form-control" id="input2" placeholder="Introducir serial de bien Nacional" style="margin-bottom: 0px;  box-shadow: unset;"
											  				onkeyup="nucleo.verificarExistenciaPublic('eq_periferico','serial_bn','fila1 #input2','fila1 #input2')" 
											  			>
											  		</div>
											  	</td>
											</tr> 
...
<script type="text/javascript">
	mtdEquipo.añadirPerifericoPublic();
	mtdPeriferico.cargarListaCaracteristicasPublic(1);
	//refrescar item

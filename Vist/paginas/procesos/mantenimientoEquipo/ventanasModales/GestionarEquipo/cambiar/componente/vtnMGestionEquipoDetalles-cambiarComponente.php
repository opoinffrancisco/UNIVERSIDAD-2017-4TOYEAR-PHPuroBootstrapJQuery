		...
		<div id="vtnCambiarComponente" class="panel panel-primary ventana-modal-panel-mediano-sintop ">
			<!-- Cabecera -->
			<div class="panel-heading">
				<h3 class="panel-title">
					Gestionar cambio de componente
			...
			<div class="panel-body"> 
				<form id="form" method="POST" >
					...
					<input type="text" id="datoControlIdCompoCambio" value="" style="display:none;"></input>
					<input type="text" id="datoControlIdCompoUsado" value="" style="display:none;"></input>
					<div  class="row">

	<form id="formADD" method="POST" ></input>					
					<div  class="row">
						<label> Componente actual </label>
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-9">
									...
									<div class="row">
										<div class="col-md-6">											
											<div class="form-group">
											    ...
											    <input type="text" class="form-control input-sm" id="capacidadtxtActual" disabled="TRUE">
											</div>											
										</div>																					
									</div>	
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<div id="listGestionCaractInterfacesComponActual" class="list-group" style="FONT-SIZE: smaller;">
					...
					<hr>
								...
								<div class="row">
									<div class="col-md-12" >
										<b>
										 	Se cambiara el componente actual por uno nuevo o usado
										</b>
									</div>
								</div>				
										...
										<ul class="nav nav-tabs nav-justified">
										  	<li role="presentation">
										  		<a href="javascript:;" class="pestana-tab-inactivo" id="tabObservarDiagnostico" 
										  			onclick="panelTabs.cambiarModalPulico('procesos/mantenimientoEquipo/ventanasModales/GestionarEquipo/cambiar/componente/nuevo.php','',datosIdsTabs=['tabObservarDiagnostico','tabObservarRealizado'],'catalogoModalSolicitudCambiar');">
										  			Nuevo
										  		</a>
										  	</li>
										  	<li role="presentation" >
											  	<a href="javascript:;" class="pestana-tab-inactivo" id="tabObservarRealizado"
											  	onclick="panelTabs.cambiarModalPulico('procesos/mantenimientoEquipo/ventanasModales/GestionarEquipo/cambiar/componente/usado.php','',datosIdsTabs=['tabObservarRealizado','tabObservarDiagnostico'],'catalogoModalSolicitudCambiar');">
										      		Usado
										    	</a>
									      	</li>										  	
										</ul>

<br>
			<div class="row">
				<div class="col-md-12" >
					<b>
						Seleccionar caracteriticas para el nuevo periferico, ingresar seriales e indicar una observación
					</b>
				</div>
			</div>				
<hr>
<form id="formADD" method="POST" class="panel-vtn-content-datos">
	...
	<div  class="row">
		<div class="col-md-3">
			  	...
			  	<div id="divBuscadorTxt" class="form-group">
					<div class="input-group">
					  ...
					  onkeyup="
							...
							mtdPeriferico.cargarListaCaracteristicasPublic(1);
					  "
					...
					<a href="javascript:;" onclick="ventanaModal.mostrarPulico('ventana-modal', datosIdsTabs=['scroll','no'])">
					    <button type="button" class="btn btn-default btn-cfg-admin" id="btnNuevo-admin"  style="width: 100%;"
										onclick="ventanaModal.cambiaMuestraVentanaModalCapaAdminPublic(
												...
												'configuracion/gestionCaracteristicasPeriferico/ventanasModales/vtnMGestionCaracteristicasPeriferico.php',
												1
										)"
					    >
				...
				<div id="pgnListCaracteristicasPerifericos">
						<div id="pagination">
							
						</div>
				</div>	
				<div id="listGestionCaractPerif" class="list-group" style="FONT-SIZE: smaller;">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
							    ...
							    <input type="text" class="form-control input-sm" id="interfaztxt" disabled="TRUE">
							</div>																						
						</div>																											
					</div>
				...
				<div  class="row">
					<div class="col-md-12">
				    	...
				    	<textarea type="text" name="observación" class="campo-control form-control input-sm textarea" id="observacionTxt" placeholder="Ingresar observación" 
				    		...
				    		data-solonumero="0" data-sololetra="0" data-sololetrayespacio="0" data-descripcion="1" data-vcorreo="0" required="true" > El periferico actual esta dañado
				  		</textarea>		
					...
					<div class="col-md-2 col-md-offset-10">
				      	<label for="recurso" style="color:#ffffff;">|||||||||||||||||:</label>							  
							...
							<a href="javascript:;" onclick="">
							    <button type="button" class="btn btn-default" onclick="mtdMantenimientoEquipo.guardarCambioPerifericoPublic();" >
							    <!-- disabled="false" -->

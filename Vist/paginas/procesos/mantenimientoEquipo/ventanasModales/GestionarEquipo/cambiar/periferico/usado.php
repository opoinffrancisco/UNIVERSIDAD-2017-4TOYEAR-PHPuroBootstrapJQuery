<br>
			<div class="row">
				<div class="col-md-12" >
					<b>
						Seleccionar el periferico disponible e indicar una observación
					</b>
				</div>
			</div>				
<hr>
<form id="formADD" method="POST" class="panel-vtn-content-datos" >
	...
	<div  class="row">
		<div class="col-md-3">
		  	...
		  	<div id="divBuscadorTxt" class="form-group">
				<div class="input-group">
				  ...
				  onkeyup="
						...
						mtdMantenimientoEquipo.cargarListaPerifericosDisponiblesPublic();
				  "
			...
			<b>
				Seleccionar periferico
			</b>				
			<div id="pgnListPeriferico">
					<div id="pagination">
						
					</div>
			</div>	
			<div id="listGestionPeriferico" class="list-group" style="FONT-SIZE: smaller;">
					...
					<div class="col-md-2 col-md-offset-10">
				      	<label for="recurso" style="color:#ffffff;">|||||||||||||||||:</label>							  
							...
							<a href="javascript:;" onclick="">
							    <button type="button" class="btn btn-default" onclick="mtdMantenimientoEquipo.guardarCambioPerifericoUsadoPublic();" >
							    <!-- disabled="false" -->

		...
		<div id="vtnMantenimientoEquipoDesincEquipo" class="vtn-desincorporar panel panel-primary ventana-modal-panel-mediano-sintop ">
			<!-- Cabecera -->
						...
						<div  class="row">
							<div class="col-md-12">
						    	...
						    	<textarea type="text" name="observacion" class="campo-control form-control input-sm textarea" id="observacionTxt" placeholder="" 
						    		...
						    		data-solonumero="0" data-sololetra="0" data-sololetrayespacio="0" data-descripcion="1" data-vcorreo="0" required="true" > El equipo esta dañado
						  		</textarea>		
							...
							<div class="col-md-2 col-md-offset-10">
						      	<label for="recurso" style="color:#ffffff;">|||||||||||||||||:</label>							  
									...
									<a href="javascript:;" onclick="">
									    <button type="button" class="btn btn-default" onclick="mtdMantenimientoEquipo.desincorporarEquipoPublic();" >
									    <!-- disabled="false" -->

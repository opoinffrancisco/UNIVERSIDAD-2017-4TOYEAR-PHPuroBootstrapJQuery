		...
		<div id="vtnMantenimientoEquipoDesincPerif" class="ventana-desincorporacion panel panel-primary ventana-modal-panel-mediano-sintop ">
			<!-- Cabecera -->
			<div class="panel-heading">
				<h3 class="panel-title">
					Desincorporar periferico del equipo 
						...
						<div  class="row">
							<div class="col-md-12">
						    	...
						    	<textarea type="text" name="observacion" class="campo-control form-control input-sm textarea" id="observacionTxt" placeholder="" 
						    		...
						    		data-solonumero="0" data-sololetra="0" data-sololetrayespacio="0" data-descripcion="1" data-vcorreo="0" required="true" > El periferico esta dañado
						  		</textarea>		
									...
									<a href="javascript:;" onclick="">
									    <button type="button" class="btn btn-default" 
										    onclick="mtdMantenimientoEquipo.desincorporarPerCompSoftPublic(
										     'equipo_periferico','id_periferico'
										     );" >
									    <!-- disabled="false" -->

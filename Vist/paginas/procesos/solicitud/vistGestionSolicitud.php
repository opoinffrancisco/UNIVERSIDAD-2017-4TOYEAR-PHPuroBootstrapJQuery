<!-- Iniciando carga de complementos -->
	...
	<script type="text/javascript">
        panelTabs.cambiarCatalogoPublic('procesos/solicitud/catalogos/ctlgGestionSolicitud.php');
		panelTabs.cambiarVentanaModalPublic('procesos/solicitud/ventanasModales/vtnMGestionSolicitud.php');        
	</script>
...
<script>
		nucleo.guardarBitacoraPublic("INGRESO EN EL MODULO DE PROCESAMIENTO DE SOLICITUD");			
</script>
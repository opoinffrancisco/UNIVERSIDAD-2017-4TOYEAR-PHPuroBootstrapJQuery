<!-- Iniciando carga de complementos -->
	...
	<script type="text/javascript">
        panelTabs.cambiarCatalogoPublic('procesos/asginarEquipoPersona/catalogos/ctlgGestionAsignarEquipoPersona.php');
	</script>
...
<div class="panel panel-primary"> 
	...
	<div class="panel-heading" >
		<h3 class="panel-title">Asignar equipo : </h3> 
	</div> 
	<!--Catalogo-->
	<div id="catalogo">
...
<script>
		nucleo.guardarBitacoraPublic("INGRESO EN EL MODULO DE PROCESAMIENTO DE ASIGNACIONES");			
</script>
		...
		<div class="panel-body">
			...
			<form id="form-no-login">
				<div class="row">
					...
					<div class="col-md-7 col-md-offset-1">	  
					    	...
					    	<input type="text" name="nombre" class="campo-clave  form-control input-sm" id="usuarioTxt" placeholder="Ingresar usuario" 
						  		onkeypress="nucleo.verificarDatosInputPublic(event,this,'divUsuarioTxt')"								    							  			
					    		data-cantmax="30" maxlength="30" data-cantmin="4" data-vexistencia="0" 
					    		data-solonumero="0" data-sololetra="1" data-sololetrayespacio="0" data-vcorreo="0" 
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1" >
			  		<button type="submit" id="btnIniciarSesion" class="btn btn-default"  style="width: 100%;"  onclick="nucleo.iniciarSesionPublic('divUsuarioTxt','divContrasenaTxt')" >Iniciar sesión</button>
			  	</div>
		  	</div>
		</div>	  			
	</div>
...
<script type="text/javascript">
	nucleo.activarEnvioInicSesionPublic();

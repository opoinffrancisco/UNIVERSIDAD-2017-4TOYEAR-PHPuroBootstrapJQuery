    ...
    <tbody class="resultado">
      ...
      <tr>
        <td class="fila-rpt-title" colspan="6" style="color:black;">
          <b>
            CONCURRENCIA DE LA TAREAS REALIZADAS
          </b>
        </td>
      </tr>    
      <?php
      ...
      <tr><td class="fila-rpt-space-fila" colspan="6"></td></tr>        
      <tr class="fila-rpt">
        <td class="columna-nombre" colspan="2" ><b>PROMEDIO</b></td>
      ...
      <tr class="fila-rpt">
        <td class="columna-dato" colspan="2" ><?php echo $datos_fila['PROMEDIO'];?></td>
        <td class="columna-dato" colspan="4" ><?php echo $datos_fila['NOMBRE_TAREA'];?></td> 
      </tr >      
